...
<html lang="en">
  ...
  <head>
    ...
    <style>
        input{
            width:1085px;height:40px;border:1px solid #ddd;padding-left:10px;
        }
        textarea{
            width:1085px;height:400px;border:1px solid #ddd;padding-left:10px;
        }
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h2>Tạo bài viết mới cho blog</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
          <div class="col-lg-12 col-md-12 mx-auto">
              <form class="form-control">
                  <label><h4>Ten bai viet</h4>
                      <input type="text" placeholder="Nhap ten bao viet">
                  </label><br>
                  <label><h4>Noi dung tom tat</h4>
                      <textarea placeholder="Nhap noi dung tom tat"></textarea>
                  </label><br>
                  <label><h4>Noi dung bai viet</h4>
                         <textarea placeholder="Nhap noi dung"></textarea>
                  </label><br>
                  <label>
                      <button type="button" class="btn btn-success">Tao bai viet</button>
                  </label>
